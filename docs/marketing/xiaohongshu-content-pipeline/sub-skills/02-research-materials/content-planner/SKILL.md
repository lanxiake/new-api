...
|--------|---------|-------|
| `scripts/wechat_search.js` | Sogou WeChat article search | `node "scripts/wechat_search.js" "keyword"` |

### Search Script Parameters

**IMPORTANT:** Run commands from this skill directory, or replace `scripts/wechat_search.js` with its absolute path.

```bash
# Basic search
node "scripts/wechat_search.js" "keyword"

# Limit result count
node "scripts/wechat_search.js" "keyword" -n 15

# Save to file
node "scripts/wechat_search.js" "keyword" -n 20 -o result.json

# Parse real URLs (extra network requests, may be blocked by anti-scraping)
node "scripts/wechat_search.js" "keyword" -n 5 -r
```
...
```bash
# Example: Tech domain
node "scripts/wechat_search.js" "AI 最新趋势" -n 10
node "scripts/wechat_search.js" "大模型应用" -n 10
node "scripts/wechat_search.js" "科技热点 2026" -n 10
```
