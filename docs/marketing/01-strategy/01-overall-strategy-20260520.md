...
| 项目 | 内容 |
|------|------|
| 核心钩子 | **充 ¥50 送 ¥50**（首充翻倍，相当于所有模型打 5 折） |
...
- 充 50 送 50 后实际折半：输入 ¥2 / 1M，输出 ¥10 / 1M

**对比参考**：官方 Max 20x 订阅约 ¥1,450/月（重度用户仍超额）；走 cc-sale + 充50送50 后，中度用户实测约 ¥260/月。
